...
setup(void)
{
	...
	int a, di, n, area = 0;
#endif
	/* hardcode same background for fuzzy highlights */
	colors[SchemeSelHighlight][1] = colors[SchemeSel][1];
	colors[SchemeNormHighlight][1] = colors[SchemeNorm][1];
	/* init appearance */
...
usage(void)
{
	fputs("usage: dmenu [-bfiv] [-l lines] [-p prompt] [-fn font] [-m monitor]\n"
	      ...
	      "             [-nhf color] [-shf color] [-w windowid] [-it text]\n", stderr);
	exit(1);
}
